...
var (
	...
	ErrInvalidProposalAmount  = sdkerrors.Register(ModuleName, 8, "invalid deflationary pool spend proposal amount")
	ErrEmptyProposalRecipient = sdkerrors.Register(ModuleName, 9, "invalid deflationary pool spend proposal recipient")
)
